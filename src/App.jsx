...
/**
 * One-page React web app: Attack playbooks with progressive checklist.
 * - Click an attack (accordion)
 * - Inside: three sections (Stop Now / Prevent Next Time / Train Employee)
 * - Each section is a step-by-step checklist where the next step is locked until the previous is checked.
 * - Built with TailwindCSS classes (works if Tailwind is configured).
 */
...
export default function App() {
  const [openId, setOpenId] = useState("phishing");
...
<div>
Built for Intune + Entra ID + Microsoft Defender workflows (MD-102 style). Customize the
playbooks as your org policies change.
</div>
...
<div>
📧 Email: peter.s.rezik@gmail.com | 📞 Phone: +971-504858376
</div>
</footer>
      </div>
    </div>
